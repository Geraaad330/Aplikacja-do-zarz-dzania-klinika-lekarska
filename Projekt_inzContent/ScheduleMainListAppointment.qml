...
Rectangle {
    ...
    Component.onCompleted: {
        ...
        bridgeRoom.updateAppointmentsList();
    }
    ...
    Text {
        text: qsTr("Zarządzanie harmonogramem - lista wizyt")
    ...
    Item {
        id: mainContainerAppointments
        anchors.fill: parent

        // Definiujemy wspólne właściwości szerokości kolumn dla tabeli wizyt
        property real colWidthAppointmentId: 0.037
        property real colWidthAssignmentId: 0.04
        property real colWidthPatientName: 0.09
        property real colWidthEmployeeName: 0.09
        property real colWidthServiceId: 0.037
        property real colWidthServiceType: 0.15
        property real colWidthReservationId: 0.045
        property real colWidthRoomNumber: 0.05
        property real colWidthAppointmentDate: 0.1
        property real colWidthAppointmentStatus: 0.08
        property real colWidthNotes: 0.15

        Column {
            id: listContainerAppointments
            anchors {
                right: parent.right
                top: parent.top
            ...
            // Nagłówki tabeli wizyt
            Row {
                id: headerRowAppointments
                width: listContainerAppointments.width
                height: listContainerAppointments.height * 0.08  // 8% wysokości kontenera
                spacing: 20

                Text {
                    text: "Id Wizyty"
                    width: headerRowAppointments.width * mainContainerAppointments.colWidthAppointmentId
                    font.pixelSize: 14
                    verticalAlignment: Text.AlignVCenter
                    color: backendBridge.isDarkMode ? "#FFFFFF" : "#ffde59"
                ...
                Text {
                    text: "Id Przypis."
                    width: headerRowAppointments.width * mainContainerAppointments.colWidthAssignmentId
                    font.pixelSize: 14
                    verticalAlignment: Text.AlignVCenter
                    color: backendBridge.isDarkMode ? "#FFFFFF" : "#ffde59"
                    wrapMode: Text.WordWrap
                ...
                Text {
                    text: "Pacjent"
                    width: headerRowAppointments.width * mainContainerAppointments.colWidthPatientName
                    font.pixelSize: 14
                    verticalAlignment: Text.AlignVCenter
                    color: backendBridge.isDarkMode ? "#FFFFFF" : "#ffde59"
                    wrapMode: Text.WordWrap
                ...
                Text {
                    text: "Pracownik"
                    width: headerRowAppointments.width * mainContainerAppointments.colWidthEmployeeName
                    font.pixelSize: 14
                    verticalAlignment: Text.AlignVCenter
                    color: backendBridge.isDarkMode ? "#FFFFFF" : "#ffde59"
                    wrapMode: Text.WordWrap
                ...
                Text {
                    text: "ID Usługi"
                    width: headerRowAppointments.width * mainContainerAppointments.colWidthServiceId
                    font.pixelSize: 14
                    verticalAlignment: Text.AlignVCenter
                    color: backendBridge.isDarkMode ? "#FFFFFF" : "#ffde59"
                    elide: Text.ElideRight
                ...
                Text {
                    text: "Usługa"
                    width: headerRowAppointments.width * mainContainerAppointments.colWidthServiceType
                    font.pixelSize: 14
                    verticalAlignment: Text.AlignVCenter
                    color: backendBridge.isDarkMode ? "#FFFFFF" : "#ffde59"
                    wrapMode: Text.WordWrap
                ...
                Text {
                    text: "ID Rezerw."
                    width: headerRowAppointments.width * mainContainerAppointments.colWidthReservationId
                    font.pixelSize: 14
                    verticalAlignment: Text.AlignVCenter
                    color: backendBridge.isDarkMode ? "#FFFFFF" : "#ffde59"
                    wrapMode: Text.WordWrap
                ...
                Text {
                    text: "Pokój"
                    width: headerRowAppointments.width * mainContainerAppointments.colWidthRoomNumber
                    font.pixelSize: 14
                    verticalAlignment: Text.AlignVCenter
                    color: backendBridge.isDarkMode ? "#FFFFFF" : "#ffde59"
                    wrapMode: Text.WordWrap
                ...
                Text {
                    text: "Data"
                    width: headerRowAppointments.width * mainContainerAppointments.colWidthAppointmentDate
                    font.pixelSize: 14
                    verticalAlignment: Text.AlignVCenter
                    color: backendBridge.isDarkMode ? "#FFFFFF" : "#ffde59"
                    wrapMode: Text.WordWrap
                ...
                Text {
                    text: "Status"
                    width: headerRowAppointments.width * mainContainerAppointments.colWidthAppointmentStatus
                    font.pixelSize: 14
                    verticalAlignment: Text.AlignVCenter
                    color: backendBridge.isDarkMode ? "#FFFFFF" : "#ffde59"
                    wrapMode: Text.WordWrap
                ...
                Text {
                    text: "Notatki"
                    width: headerRowAppointments.width * mainContainerAppointments.colWidthNotes
                    font.pixelSize: 14
                    verticalAlignment: Text.AlignVCenter
                    color: backendBridge.isDarkMode ? "#FFFFFF" : "#ffde59"
                    wrapMode: Text.WordWrap
            ...
            // ScrollView z listą wizyt
            ScrollView {
                id: idScrollViewAppointments
                width: listContainerAppointments.width
                height: listContainerAppointments.height * 0.92
                clip: true

                ListView {
                    id: appointmentsListView
                    anchors.fill: parent
                    model: appointmentsModel

                    delegate: Item {
                        width: appointmentsListView.width
                        height: 60
                        Row {
                            spacing: 20
                            anchors.fill: parent
                            ...
                            Text {
                                text: model.appointment_id
                                width: appointmentsListView.width * mainContainerAppointments.colWidthAppointmentId
                                font.pixelSize: 14
                                verticalAlignment: Text.AlignVCenter
                            ...
                            Text {
                                text: model.fk_assignment_id
                                width: appointmentsListView.width * mainContainerAppointments.colWidthAssignmentId
                                font.pixelSize: 14
                                verticalAlignment: Text.AlignVCenter
                                horizontalAlignment: Text.AlignLeft
                                color: backendBridge.isDarkMode ? "#ff0000" : "#FFFFFF"
                            ...
                            Text {
                                ...
                                width: appointmentsListView.width * mainContainerAppointments.colWidthPatientName
                                font.pixelSize: 14
                                verticalAlignment: Text.AlignVCenter
                                horizontalAlignment: Text.AlignLeft
                                color: backendBridge.isDarkMode ? "#ff0000" : "#FFFFFF"
                            ...
                            Text {
                                ...
                                width: appointmentsListView.width * mainContainerAppointments.colWidthEmployeeName
                                font.pixelSize: 14
                                verticalAlignment: Text.AlignVCenter
                                horizontalAlignment: Text.AlignLeft
                                color: backendBridge.isDarkMode ? "#ff0000" : "#FFFFFF"
                            ...
                            Text {
                                text: model.fk_service_id
                                width: appointmentsListView.width * mainContainerAppointments.colWidthServiceId
                                font.pixelSize: 14
                                verticalAlignment: Text.AlignVCenter
                                horizontalAlignment: Text.AlignLeft
                                color: backendBridge.isDarkMode ? "#ff0000" : "#FFFFFF"
                            ...
                            Text {
                                ...
                                width: appointmentsListView.width * mainContainerAppointments.colWidthServiceType
                                font.pixelSize: 14
                                verticalAlignment: Text.AlignVCenter
                                horizontalAlignment: Text.AlignLeft
                                color: backendBridge.isDarkMode ? "#ff0000" : "#FFFFFF"
                            ...
                            Text {
                                ...
                                width: appointmentsListView.width * mainContainerAppointments.colWidthReservationId
                                font.pixelSize: 14
                                verticalAlignment: Text.AlignVCenter
                                horizontalAlignment: Text.AlignLeft
                                color: backendBridge.isDarkMode ? "#ff0000" : "#FFFFFF"
                            ...
                            Text {
                                ...
                                width: appointmentsListView.width * mainContainerAppointments.colWidthRoomNumber
                                font.pixelSize: 14
                                verticalAlignment: Text.AlignVCenter
                                horizontalAlignment: Text.AlignLeft
                                color: backendBridge.isDarkMode ? "#ff0000" : "#FFFFFF"
                            ...
                            Text {
                                text: model.appointment_date
                                width: appointmentsListView.width * mainContainerAppointments.colWidthAppointmentDate
                                font.pixelSize: 14
                                verticalAlignment: Text.AlignVCenter
                                horizontalAlignment: Text.AlignLeft
                                color: backendBridge.isDarkMode ? "#ff0000" : "#FFFFFF"
                            ...
                            Text {
                                text: model.appointment_status
                                width: appointmentsListView.width * mainContainerAppointments.colWidthAppointmentStatus
                                font.pixelSize: 14
                                verticalAlignment: Text.AlignVCenter
                                horizontalAlignment: Text.AlignLeft
                                color: backendBridge.isDarkMode ? "#ff0000" : "#FFFFFF"
                            ...
                            Text {
                                text: model.notes
                                width: appointmentsListView.width * mainContainerAppointments.colWidthNotes
                                font.pixelSize: 14
                                verticalAlignment: Text.AlignVCenter
                                horizontalAlignment: Text.AlignLeft
                                color: backendBridge.isDarkMode ? "#ff0000" : "#FFFFFF"
            ...
            Connections {
                target: bridgeRoom
                function onAppointmentsListChanged(appointments) {
                    appointmentsModel.clear();
                    for (let i = 0; i < appointments.length; i++) {
                        let appointment = appointments[i];
                        for (let key in appointment) {
                            if (appointment[key] === undefined || appointment[key] === null) {
                                appointment[key] = "Brak danych";
                            }
                        }
                        appointmentsModel.append(appointment);
                    }
                }
            }
        }
