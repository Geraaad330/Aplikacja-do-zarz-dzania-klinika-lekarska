...
Rectangle {
    ...
    Component.onCompleted: {
        ...
        backendBridge.updatePrescriptionsDataForUser(); // Wywołanie funkcji
    }
    ...
    Text {
        text: qsTr("Panel pacjenci - lista recept")
    ...
    Item {
        ...
        property real colWidthId: 0.055
        property real colWidthAppId: 0.055
        property real colWidthName: 0.15
        property real colWidthStatus: 0.05
        property real colWidthDrug: 0.125
        property real colWidthDose: 0.08
        property real colWidthPrice: 0.08
        property real colWidthCode: 0.08
        ...
        Column {
            ...
            Row {
                ...
                Text {
                    text: "ID recepty"
                    width: headerRow.width * mainContainer.colWidthId
                    // horizontalAlignment: Text.AlignHCenter
                    verticalAlignment: Text.AlignVCenter
                    font.pixelSize: 15
                    color: backendBridge.isDarkMode ? "#FFFFFF" : "#ffde59"
                ...
                Text {
                    text: "nazwa leku"
                    width: headerRow.width * mainContainer.colWidthDrug
                    // horizontalAlignment: Text.AlignHCenter
                    verticalAlignment: Text.AlignVCenter
                    font.pixelSize: 17
                    color: backendBridge.isDarkMode ? "#FFFFFF" : "#ffde59"
                ...
                Text {
                    text: "dawka [mg]"
                    width: headerRow.width * mainContainer.colWidthDose
                    // horizontalAlignment: Text.AlignHCenter
                    verticalAlignment: Text.AlignVCenter
                    font.pixelSize: 15
                    color: backendBridge.isDarkMode ? "#FFFFFF" : "#ffde59"
                ...
                Text {
                    text: "cena leku"
                    width: headerRow.width * mainContainer.colWidthPrice
                    // horizontalAlignment: Text.AlignHCenter
                    verticalAlignment: Text.AlignVCenter
                    font.pixelSize: 17
                    color: backendBridge.isDarkMode ? "#FFFFFF" : "#ffde59"
                ...
                Text {
                    text: "kod recepty"
                    width: headerRow.width * mainContainer.colWidthCode
                    // horizontalAlignment: Text.AlignHCenter
                    verticalAlignment: Text.AlignVCenter
                    font.pixelSize: 17
                    color: backendBridge.isDarkMode ? "#FFFFFF" : "#ffde59"
                ...
                ListView {
                    ...
                    delegate: Item {
                        ...
                        Row {
                            ...
                            Text {
                                text: model.prescription_id
                                width: diagnosesListView.width * mainContainer.colWidthId
                                font.pixelSize: 17
                                verticalAlignment: Text.AlignVCenter
                            ...
                            Text {
                                ...
                                width: diagnosesListView.width * mainContainer.colWidthDrug
                                font.pixelSize: 17
                                verticalAlignment: Text.AlignVCenter
                                color: backendBridge.isDarkMode ? "#ff0000" : "#FFFFFF"
                                wrapMode: Text.WordWrap       // Tekst zawija się, gdy nie mieści się w zadanej szerokości
                            ...
                            Text {
                                text: model.dosage
                                width: diagnosesListView.width * mainContainer.colWidthDose
                                font.pixelSize: 17
                                verticalAlignment: Text.AlignVCenter
                                color: backendBridge.isDarkMode ? "#ff0000" : "#FFFFFF"
                                wrapMode: Text.WordWrap       // Tekst zawija się, gdy nie mieści się w zadanej szerokości
                            ...
                            Text {
                                text: model.medicine_price
                                width: diagnosesListView.width * mainContainer.colWidthPrice
                                font.pixelSize: 17
                                verticalAlignment: Text.AlignVCenter
                                color: backendBridge.isDarkMode ? "#ff0000" : "#FFFFFF"
                                wrapMode: Text.WordWrap       // Tekst zawija się, gdy nie mieści się w zadanej szerokości
                            ...
                            Text {
                                text: model.prescription_code
                                width: diagnosesListView.width * mainContainer.colWidthCode
                                font.pixelSize: 17
                                verticalAlignment: Text.AlignVCenter
                                color: backendBridge.isDarkMode ? "#ff0000" : "#FFFFFF"
                                wrapMode: Text.WordWrap       // Tekst zawija się, gdy nie mieści się w zadanej szerokości
            ...
            Connections {
                ...
                // Obsługa poprawnych danych recept
                function onPrescriptionsDataFetched(data) {
                    prescriptionsModel.clear();
                    ...
                    for (let record of data.records) {
                        ...
                        prescriptionsModel.append(record);
                    }
                }

                // NOWA OBSŁUGA BŁĘDU - WYŚWIETLANIE KOMUNIKATU O BRAKU UPRAWNIEŃ
