...
Rectangle {
    ...
    Text {
        text: qsTr("Panel pracownicy - lista przypisania usług do pracowników")
    ...
    Item {
        ...
        // Definiujemy szerokości kolumn dla tabeli
        property real colWidthEmployeeServiceId: 0.05
        property real colWidthEmployeeId: 0.05
        property real colWidthFirstName: 0.07
        property real colWidthLastName: 0.07
        property real colWidthServiceId: 0.06
        ...
        Column {
            ...
            Row {
                ...
                Text {
                    text: "Id powiązania"
                    width: headerRowEmployees.width * mainContainerEmployees.colWidthEmployeeServiceId
                    font.pixelSize: 15
                    verticalAlignment: Text.AlignVCenter
                    color: backendBridge.isDarkMode ? "#FFFFFF" : "#ffde59"
                ...
                Text {
                    text: "Id usługi"
                    width: headerRowEmployees.width * mainContainerEmployees.colWidthServiceId
                    font.pixelSize: 17
                    verticalAlignment: Text.AlignVCenter
                    color: backendBridge.isDarkMode ? "#FFFFFF" : "#ffde59"
                    elide: Text.ElideRight
                ...
                Text {
                    text: "Typ usługi"
                    width: headerRowEmployees.width * mainContainerEmployees.colWidthServiceType
                    font.pixelSize: 17
                    verticalAlignment: Text.AlignVCenter
                    color: backendBridge.isDarkMode ? "#FFFFFF" : "#ffde59"
                    elide: Text.ElideRight
                ...
                Text {
                    text: "Status"
                    width: headerRowEmployees.width * mainContainerEmployees.colWidthIsActive
                    font.pixelSize: 17
                    verticalAlignment: Text.AlignVCenter
                    color: backendBridge.isDarkMode ? "#FFFFFF" : "#ffde59"
                    elide: Text.ElideRight
            ...
            // ScrollView z listą powiązań pracowników z usługami
            ScrollView {
                ...
                ListView {
                    id: employeesServicesListView
                    anchors.fill: parent
                    model: employeesServicesModel

                    delegate: Item {
                        width: employeesServicesListView.width
                        height: 60
                        Row {
                            spacing: 35
                            anchors.fill: parent
                            ...
                            Text {
                                text: model.employee_service_id
                                width: employeesServicesListView.width * mainContainerEmployees.colWidthEmployeeServiceId
                                font.pixelSize: 17
                                verticalAlignment: Text.AlignVCenter
                            ...
                            Text {
                                ...
                                width: employeesServicesListView.width * mainContainerEmployees.colWidthEmployeeId
                                font.pixelSize: 17
                                verticalAlignment: Text.AlignVCenter
                                color: backendBridge.isDarkMode ? "#ff0000" : "#FFFFFF"
                                wrapMode: Text.WordWrap
                            ...
                            Text {
                                ...
                                width: employeesServicesListView.width * mainContainerEmployees.colWidthFirstName
                                font.pixelSize: 17
                                verticalAlignment: Text.AlignVCenter
                                color: backendBridge.isDarkMode ? "#ff0000" : "#FFFFFF"
                                wrapMode: Text.WordWrap
                            ...
                            Text {
                                ...
                                width: employeesServicesListView.width * mainContainerEmployees.colWidthLastName
                                font.pixelSize: 17
                                verticalAlignment: Text.AlignVCenter
                                color: backendBridge.isDarkMode ? "#ff0000" : "#FFFFFF"
                                wrapMode: Text.WordWrap
                            ...
                            Text {
                                ...
                                width: employeesServicesListView.width * mainContainerEmployees.colWidthServiceId
                                font.pixelSize: 17
                                verticalAlignment: Text.AlignVCenter
                                color: backendBridge.isDarkMode ? "#ff0000" : "#FFFFFF"
                                wrapMode: Text.WordWrap
                            ...
                            Text {
                                ...
                                width: employeesServicesListView.width * mainContainerEmployees.colWidthServiceType
                                font.pixelSize: 17
                                verticalAlignment: Text.AlignVCenter
                                color: backendBridge.isDarkMode ? "#ff0000" : "#FFFFFF"
                                wrapMode: Text.WordWrap
                            ...
                            Text {
                                ...
                                width: employeesServicesListView.width * mainContainerEmployees.colWidthIsActive
                                font.pixelSize: 17
                                verticalAlignment: Text.AlignVCenter
                                color: backendBridge.isDarkMode ? "#ff0000" : "#FFFFFF"
                                wrapMode: Text.WordWrap
            ...
            ListModel {
                id: employeesServicesModel
            }

            Component.onCompleted: {
                bridgeEmployee.fetchFormattedEmployeeServices();
            }

            Connections {
                target: bridgeEmployee
                function onFormattedEmployeeServicesChanged(data) {
                    employeesServicesModel.clear();
                    for (let record of data) {
                        ...
                        employeesServicesModel.append(record);
                    }
                }
            }
        }
