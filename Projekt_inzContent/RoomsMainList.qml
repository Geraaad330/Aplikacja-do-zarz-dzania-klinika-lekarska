...
Rectangle {
    ...
    Component.onCompleted: {
        ...
        bridgeRoom.updateRoomTypesList();
        bridgeRoom.updateRoomsList();
    }
    ...
    Text {
        text: qsTr("Panel pokoje i rezerwacje - pokoje")
    ...
    Item {
        id: mainContainerRooms
        anchors.fill: parent

        // Definiujemy szerokości kolumn dla tabeli typów pokoi
        property real colWidthRoomTypeId: 0.24
        property real colWidthRoomType: 0.65

        Column {
            id: listContainerRooms
            anchors {
                right: parent.right
                top: parent.top
            ...
            Row {
                id: headerRowRooms
                width: listContainerRooms.width
                height: listContainerRooms.height * 0.08  // 8% wysokości kontenera
                spacing: 35

                Text {
                    text: "Id Typu Pokoju"
                    width: headerRowRooms.width * mainContainerRooms.colWidthRoomTypeId
                    font.pixelSize: 17
                    verticalAlignment: Text.AlignVCenter
                    color: backendBridge.isDarkMode ? "#FFFFFF" : "#ffde59"
                    wrapMode: Text.WordWrap
                    clip: true
                    maximumLineCount: 2  // Ogranicza do maksymalnie 2 linii
                }
                Text {
                    text: "Nazwa Typu Pokoju"
                    width: headerRowRooms.width * mainContainerRooms.colWidthRoomType
                    font.pixelSize: 17
                    verticalAlignment: Text.AlignVCenter
                    color: backendBridge.isDarkMode ? "#FFFFFF" : "#ffde59"
                    elide: Text.ElideRight
            ...
            // ScrollView z listą typów pokoi
            ScrollView {
                id: idScrollViewRooms
                width: listContainerRooms.width
                height: listContainerRooms.height * 0.92
                clip: true

                ListView {
                    id: roomTypesListView
                    anchors.fill: parent
                    model: roomTypesModel

                    delegate: Item {
                        width: roomTypesListView.width
                        height: 60
                        Row {
                            spacing: 35
                            anchors.fill: parent
                            ...
                            Text {
                                text: model.room_type_id
                                width: roomTypesListView.width * mainContainerRooms.colWidthRoomTypeId
                                font.pixelSize: 17
                                verticalAlignment: Text.AlignVCenter
                            ...
                            Text {
                                ...
                                width: roomTypesListView.width * mainContainerRooms.colWidthRoomType
                                font.pixelSize: 17
                                verticalAlignment: Text.AlignVCenter
                                horizontalAlignment: Text.AlignLeft
                                color: (backendBridge && backendBridge.isDarkMode) ? "#ff0000" : "#FFFFFF"
            ...
            // Obsługa sygnału zmiany listy typów pokoi
            Connections {
                target: bridgeRoom
                function onRoomTypesListChanged(roomTypes) {
                    roomTypesModel.clear();
                    for (let i = 0; i < roomTypes.length; i++) {
                        let roomType = roomTypes[i];
                        for (let key in roomType) {
                            if (roomType[key] === undefined || roomType[key] === null) {
                                roomType[key] = "Brak danych";
                            }
                        }
                        roomTypesModel.append(roomType);
                    }
                }
            }
        }
    ...
    Item {
        id: mainContainerRoomsMain
        anchors.fill: parent

        // Definiujemy szerokości kolumn dla tabeli pokoi
        property real colWidthRoomId: 0.1
        property real colWidthRoomNumber: 0.114
        property real colWidthFloor: 0.08
        property real colWidthRoomTypeId: 0.12
        property real colWidthRoomType: 0.4

        Column {
            id: listContainerRoomsMain
            anchors {
                right: parent.right
                top: parent.top
                bottom: parent.bottom
            ...
            // Nagłówki tabeli pokoi
            Row {
                id: headerRowRoomsMain
                width: listContainerRoomsMain.width
                height: listContainerRoomsMain.height * 0.08  // 8% wysokości kontenera
                spacing: 35

                Text {
                    text: "Id Pokoju"
                    width: headerRowRoomsMain.width * mainContainerRoomsMain.colWidthRoomId
                    font.pixelSize: 17
                    verticalAlignment: Text.AlignVCenter
                    color: backendBridge.isDarkMode ? "#FFFFFF" : "#ffde59"
                    wrapMode: Text.WordWrap
                ...
                Text {
                    text: "Numer Pokoju"
                    width: headerRowRoomsMain.width * mainContainerRoomsMain.colWidthRoomNumber
                    font.pixelSize: 17
                    verticalAlignment: Text.AlignVCenter
                    color: backendBridge.isDarkMode ? "#FFFFFF" : "#ffde59"
                    wrapMode: Text.WordWrap
                ...
                Text {
                    text: "Piętro"
                    width: headerRowRoomsMain.width * mainContainerRoomsMain.colWidthFloor
                    font.pixelSize: 17
                    verticalAlignment: Text.AlignVCenter
                    color: backendBridge.isDarkMode ? "#FFFFFF" : "#ffde59"
                    wrapMode: Text.WordWrap
                ...
                Text {
                    text: "Id Typu Pokoju"
                    width: headerRowRoomsMain.width * mainContainerRoomsMain.colWidthRoomTypeId
                    font.pixelSize: 17
                    verticalAlignment: Text.AlignVCenter
                    color: backendBridge.isDarkMode ? "#FFFFFF" : "#ffde59"
                    wrapMode: Text.WordWrap
                ...
                Text {
                    text: "Typ Pokoju"
                    width: headerRowRoomsMain.width * mainContainerRoomsMain.colWidthRoomType
                    font.pixelSize: 17
                    verticalAlignment: Text.AlignVCenter
                    color: backendBridge.isDarkMode ? "#FFFFFF" : "#ffde59"
                    wrapMode: Text.WordWrap
            ...
            // ScrollView z listą pokoi
            ScrollView {
                id: idScrollViewRoomsMain
                width: listContainerRoomsMain.width
                height: listContainerRoomsMain.height * 0.92
                clip: true
                ...
                ListView {
                    ...
                    delegate: Item {
                        ...
                        Row {
                            ...
                            Text {
                                text: model.room_id
                                width: roomsListView.width * mainContainerRoomsMain.colWidthRoomId
                                font.pixelSize: 17
                                verticalAlignment: Text.AlignVCenter
                                horizontalAlignment: Text.AlignLeft
                                color: (backendBridge && backendBridge.isDarkMode) ? "#ff0000" : "#FFFFFF"
                            ...
                            Text {
                                ...
                                width: roomsListView.width * mainContainerRoomsMain.colWidthRoomNumber
                                font.pixelSize: 17
                                verticalAlignment: Text.AlignVCenter
                                horizontalAlignment: Text.AlignLeft
                                color: (backendBridge && backendBridge.isDarkMode) ? "#ff0000" : "#FFFFFF"
                            ...
                            Text {
                                text: model.floor
                                width: roomsListView.width * mainContainerRoomsMain.colWidthFloor
                                font.pixelSize: 17
                                verticalAlignment: Text.AlignVCenter
                                horizontalAlignment: Text.AlignLeft
                                color: (backendBridge && backendBridge.isDarkMode) ? "#ff0000" : "#FFFFFF"
                            ...
                            Text {
                                text: model.fk_room_type_id
                                width: roomsListView.width * mainContainerRoomsMain.colWidthRoomTypeId
                                font.pixelSize: 17
                                verticalAlignment: Text.AlignVCenter
                                horizontalAlignment: Text.AlignLeft
                                color: (backendBridge && backendBridge.isDarkMode) ? "#ff0000" : "#FFFFFF"
                            ...
                            Text {
                                text: model.room_type
                                width: roomsListView.width * mainContainerRoomsMain.colWidthRoomType
                                font.pixelSize: 17
                                verticalAlignment: Text.AlignVCenter
                                horizontalAlignment: Text.AlignLeft
                                color: (backendBridge && backendBridge.isDarkMode) ? "#ff0000" : "#FFFFFF"
            ...
            // Obsługa sygnału zmiany listy pokoi
            Connections {
                target: bridgeRoom
                function onRoomListChanged(rooms) {
                    roomsModel.clear();
                    for (let i = 0; i < rooms.length; i++) {
                        let room = rooms[i];
                        for (let key in room) {
                            if (room[key] === undefined || room[key] === null) {
                                room[key] = "Brak danych";
                            }
                        }
                        roomsModel.append(room);
                    }
                }
            }
        }
