...
Rectangle {
    ...
    Component.onCompleted: {
        ...
        backendBridge.updatePatientsList(); // Wywołanie funkcji
    ...
    Text {
        text: qsTr("Panel pacjenci - lista pacjentów")
    ...
    Item {
        id: mainContainerPatients
        anchors.fill: parent

        // Definiujemy wspólne właściwości szerokości kolumn dla tabeli pacjentów
        property real colWidthPatientId: 0.017
        property real colWidthFirstName: 0.06
        property real colWidthLastName: 0.07
        property real colWidthPesel: 0.065
        property real colWidthPhone: 0.0525
        property real colWidthEmail: 0.17
        property real colWidthAddress: 0.17
        property real colWidthDOB: 0.07
        property real colWidthIsAct: 0.07

        // Cała struktura (nagłówki + lista) opakowana w kolumnę
        Column {
            id: listContainerPatients
            anchors {
                /*left: idRamka.right  */       // zakładamy, że idRamka istnieje
                right: parent.right
                top: parent.top
            ...
            Row {
                id: headerRowPatients
                width: listContainerPatients.width
                height: listContainerPatients.height * 0.08  // 8% wysokości kontenera
                spacing: 35

                Text {
                    text: "Id"
                    width: headerRowPatients.width * mainContainerPatients.colWidthPatientId
                    font.pixelSize: 17
                    verticalAlignment: Text.AlignVCenter
                    color: backendBridge.isDarkMode ? "#FFFFFF" : "#ffde59"
                    elide: Text.ElideRight
                ...
                Text {
                    text: "Imię"
                    width: headerRowPatients.width * mainContainerPatients.colWidthFirstName
                    font.pixelSize: 17
                    verticalAlignment: Text.AlignVCenter
                    color: backendBridge.isDarkMode ? "#FFFFFF" : "#ffde59"
                    elide: Text.ElideRight
                ...
                Text {
                    text: "Nazwisko"
                    width: headerRowPatients.width * mainContainerPatients.colWidthLastName
                    font.pixelSize: 17
                    verticalAlignment: Text.AlignVCenter
                    color: backendBridge.isDarkMode ? "#FFFFFF" : "#ffde59"
                    elide: Text.ElideRight
                ...
                Text {
                    text: "PESEL"
                    width: headerRowPatients.width * mainContainerPatients.colWidthPesel
                    font.pixelSize: 17
                    verticalAlignment: Text.AlignVCenter
                    color: backendBridge.isDarkMode ? "#FFFFFF" : "#ffde59"
                    elide: Text.ElideRight
                ...
                Text {
                    text: "Telefon"
                    width: headerRowPatients.width * mainContainerPatients.colWidthPhone
                    font.pixelSize: 17
                    verticalAlignment: Text.AlignVCenter
                    color: backendBridge.isDarkMode ? "#FFFFFF" : "#ffde59"
                    elide: Text.ElideRight
                ...
                Text {
                    text: "Email"
                    width: headerRowPatients.width * mainContainerPatients.colWidthEmail
                    font.pixelSize: 17
                    verticalAlignment: Text.AlignVCenter
                    color: backendBridge.isDarkMode ? "#FFFFFF" : "#ffde59"
                    elide: Text.ElideRight
                ...
                Text {
                    text: "Adres"
                    width: headerRowPatients.width * mainContainerPatients.colWidthAddress
                    font.pixelSize: 17
                    verticalAlignment: Text.AlignVCenter
                    color: backendBridge.isDarkMode ? "#FFFFFF" : "#ffde59"
                    elide: Text.ElideRight
                ...
                Text {
                    text: "Data urodzenia"
                    width: headerRowPatients.width * mainContainerPatients.colWidthDOB
                    font.pixelSize: 16
                    verticalAlignment: Text.AlignVCenter
                    color: backendBridge.isDarkMode ? "#FFFFFF" : "#ffde59"
                    elide: Text.ElideRight
                ...
                Text {
                    text: "Status"
                    width: headerRowPatients.width * mainContainerPatients.colWidthIsAct
                    font.pixelSize: 17
                    verticalAlignment: Text.AlignVCenter
                    color: backendBridge.isDarkMode ? "#FFFFFF" : "#ffde59"
                    elide: Text.ElideRight
            ...
            // ScrollView z listą pacjentów
            ScrollView {
                id: idScrollViewPatients
                width: listContainerPatients.width
                height: listContainerPatients.height * 0.92  // pozostałe miejsce w kontenerze
                clip: true
                ...
                ListView {
                    ...
                    delegate: Item {
                        ...
                        height: 60   // stała wysokość pojedynczego elementu – można zmodyfikować proporcjonalnie
                        Row {
                            spacing: 35
                            anchors.fill: parent

                            Text {
                                text: model.patient_id
                                width: patientsListView.width * mainContainerPatients.colWidthPatientId
                            ...
                            Text {
                                ...
                                width: patientsListView.width * mainContainerPatients.colWidthFirstName
                                font.pixelSize: 17            // Stała wielkość czcionki (nie skalująca się)
                                verticalAlignment: Text.AlignVCenter
                                horizontalAlignment: Text.AlignLeft
                                color: (backendBridge && backendBridge.isDarkMode) ? "#ff0000" : "#FFFFFF"
                            ...
                            Text {
                                ...
                                width: patientsListView.width * mainContainerPatients.colWidthLastName
                                font.pixelSize: 17
                                verticalAlignment: Text.AlignVCenter
                            ...
                            Text {
                                text: model.pesel
                                width: patientsListView.width * mainContainerPatients.colWidthPesel
                                font.pixelSize: 17            // Stała wielkość czcionki (nie skalująca się)
                                verticalAlignment: Text.AlignVCenter
                                horizontalAlignment: Text.AlignLeft
                                color: (backendBridge && backendBridge.isDarkMode) ? "#ff0000" : "#FFFFFF"
                            ...
                            Text {
                                text: model.phone
                                width: patientsListView.width * mainContainerPatients.colWidthPhone
                                font.pixelSize: 17            // Stała wielkość czcionki (nie skalująca się)
                                verticalAlignment: Text.AlignVCenter
                                horizontalAlignment: Text.AlignLeft
                                color: (backendBridge && backendBridge.isDarkMode) ? "#ff0000" : "#FFFFFF"
                            ...
                            Text {
                                text: model.email
                                width: patientsListView.width * mainContainerPatients.colWidthEmail
                                font.pixelSize: 17            // Stała wielkość czcionki (nie skalująca się)
                                verticalAlignment: Text.AlignVCenter
                                horizontalAlignment: Text.AlignLeft
                                color: (backendBridge && backendBridge.isDarkMode) ? "#ff0000" : "#FFFFFF"
                            ...
                            Text {
                                text: model.address
                                width: patientsListView.width * mainContainerPatients.colWidthAddress
                                font.pixelSize: 17            // Stała wielkość czcionki (nie skalująca się)
                                verticalAlignment: Text.AlignVCenter
                                horizontalAlignment: Text.AlignLeft
                                color: (backendBridge && backendBridge.isDarkMode) ? "#ff0000" : "#FFFFFF"
                            ...
                            Text {
                                text: model.date_of_birth
                                width: patientsListView.width * mainContainerPatients.colWidthDOB
                                font.pixelSize: 17            // Stała wielkość czcionki (nie skalująca się)
                                verticalAlignment: Text.AlignVCenter
                                horizontalAlignment: Text.AlignLeft
                                color: (backendBridge && backendBridge.isDarkMode) ? "#ff0000" : "#FFFFFF"
                            ...
                            Text {
                                ...
                                width: patientsListView.width * mainContainerPatients.colWidthIsAct
                                font.pixelSize: 17
                                verticalAlignment: Text.AlignVCenter
                                horizontalAlignment: Text.AlignLeft
                                color: backendBridge.isDarkMode ? "#ff0000" : "#FFFFFF"
            ...
            Connections {
                ...
                function onPatientsListChanged(patients) {
                    patientsModel.clear();
                    for (let i = 0; i < patients.length; i++) {
                        let patient = patients[i];
                        for (let key in patient) {
                            if (patient[key] === undefined || patient[key] === null) {
                                patient[key] = "Brak danych";
                            }
                        }
                        // Upewnij się, że pole is_active jest dodane do modelu
                        if (!('is_active' in patient)) {
                            patient['is_active'] = "Brak danych";
                        }
                        patientsModel.append(patient);
                    }
                }
            }
        }
