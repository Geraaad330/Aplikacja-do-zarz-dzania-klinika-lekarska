...
CREATE TABLE appointments (
    ...
    appointment_date TEXT NOT NULL CHECK (
        appointment_date GLOB '[1-2][0-9][0-9][0-9]-[0-1][0-9]-[0-3][0-9] [0-9]:[0-5][0-9]' OR
...
CREATE TABLE room_reservations (
    ...
    reservation_time TEXT NOT NULL CHECK (
        reservation_time GLOB '[0-2][0-9]:[0-5][0-9]-[0-2][0-9]:[0-5][0-9]' OR
        reservation_time GLOB '[0-9]:[0-5][0-9]-[0-2][0-9]:[0-5][0-9]' OR
        reservation_time GLOB '[0-9]:[0-5][0-9]-[0-9]:[0-5][0-9]'
    ),
