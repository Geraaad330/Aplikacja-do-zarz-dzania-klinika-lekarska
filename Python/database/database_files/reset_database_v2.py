...
# print("\n".join(sys.path)) # wyświetla wszystkie ścieżki importu
# reset_database.py
import sys
from controllers.database_controller import DatabaseController

# Dodanie ścieżki do projektu (jeśli wymagane)
sys.path.append(r"C:\gry-programy\Qt\Qt projekty\Projekt_inz")

def reset_database():
    """
    Resetuje bazę danych, usuwając wszystkie dane i odtwarzając strukturę tabel zgodnie z pełnym schematem.
    """
    ...
    # Wyłączenie kluczy obcych przed usuwaniem danych
    cursor.execute("PRAGMA foreign_keys = OFF;")

    # Odtwarzanie struktury tabel zgodnie z pełnym schematem
    create_schema_query = """
    ...
    # Włączenie kluczy obcych po odtworzeniu tabel
    cursor.execute("PRAGMA foreign_keys = ON;")

    print("Baza danych została zresetowana i odtworzono strukturę tabel.")
